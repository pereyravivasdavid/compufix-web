...
export default function Home() {
  ...
  // NUEVO: Lógica para evitar que los enlaces con "#" traben el botón "Atrás"
  useEffect(() => {
    const manejarEnlacesInternos = (e: MouseEvent) => {
      const target = e.target as HTMLElement;
      const link = target.closest('a');
      
      // Si el clic no fue en un enlace, o el enlace no empieza con "#", lo ignoramos
      if (!link) return;
      const href = link.getAttribute('href');
      if (!href || !href.startsWith('#') || href === '#') return;

      // Prevenimos el comportamiento por defecto (que ensucia el historial)
      e.preventDefault();
      
      // Buscamos la sección y hacemos scroll suave
      const elementoDestino = document.querySelector(href);
      if (elementoDestino) {
        elementoDestino.scrollIntoView({ behavior: 'smooth' });
        
        // Esto cambia la URL de arriba para que se vea linda, pero SIN agregar un paso al botón "Atrás"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <article className="group bg-zinc-950 p-8 rounded-none border border-zinc-800 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] hover:-translate-y-1 relative overflow-hidden">
              ...
              <a href="#detalle-mantenimiento" title="Consultar por reparación de PC" className="text-sm font-medium text-blue-500 hover:text-blue-400 transition-all flex items-center gap-1 group-hover:drop-shadow-[0_0_5px_rgba(59,130,246,0.5)]">
            ...
            <article className="group bg-zinc-950 p-8 rounded-none border border-zinc-800 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] hover:-translate-y-1 relative overflow-hidden">
              ...
              <a href="#detalle-optimizacion" title="Consultar por actualización de hardware" className="text-sm font-medium text-blue-500 hover:text-blue-400 transition-all flex items-center gap-1 group-hover:drop-shadow-[0_0_5px_rgba(59,130,246,0.5)]">
                Saber más <span aria-hidden="true" className="transition-transform group-hover:translate-x-1">→</span>
              </a>
            </article>
            ...
            <article className="group bg-zinc-950 p-8 rounded-none border border-zinc-800 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] hover:-translate-y-1 relative overflow-hidden">
              ...
              <a href="#detalle-cctv" title="Consultar por instalación de cámaras" className="text-sm font-medium text-blue-500 hover:text-blue-400 transition-all flex items-center gap-1 group-hover:drop-shadow-[0_0_5px_rgba(59,130,246,0.5)]">
                Saber más <span aria-hidden="true" className="transition-transform group-hover:translate-x-1">→</span>
              </a>
            </article>
            ...
            <article className="group bg-zinc-950 p-8 rounded-none border border-zinc-800 transition-all duration-300 hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] hover:-translate-y-1 relative overflow-hidden">
              ...
              <a href="#detalle-desarrollo" title="Consultar por desarrollo de páginas web" className="text-sm font-medium text-blue-500 hover:text-blue-400 transition-all flex items-center gap-1 group-hover:drop-shadow-[0_0_5px_rgba(59,130,246,0.5)]">
                Saber más <span aria-hidden="true" className="transition-transform group-hover:translate-x-1">→</span>
              </a>
            </article>
